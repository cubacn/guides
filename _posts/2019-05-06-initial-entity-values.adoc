...
image::initial-entity-values/regular-checkup-1-select-pet.png[Step 1: 选择宠物 , link="/guides/images/initial-entity-values/regular-checkup-1-select-pet.png"]
...
* https://doc.cuba-platform.cn/manual-{cuba_version}-chs/opening_screens.html#screenBuilders[Screen Builders 参考文档]
* https://www.cuba-platform.cn/guides/decouple-business-logic-with-app-events[指南：使用应用程序事件解耦应用程序逻辑]
