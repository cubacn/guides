...
* https://doc.cuba-platform.cn/manual-{cuba_version}-chs/messages.html[CUBA docs: Messages Interface]
* https://doc.cuba-platform.cn/manual-{cuba_version}-chs/localization.html[CUBA docs: Localization]
